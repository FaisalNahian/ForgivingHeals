<script type="text/template" id="reaction_item">
	    ...
	    <div class="col-md-2 col-xs-2 vote-block">
	        <ul>
	            ...
	            <li>
	            	<a href="javascript:void(0)" data-name="accept-reaction" class="action accept-reaction img-circle">
	    ...
	    <div class="col-md-9 col-xs-9 q-right-content">
	        ...
	        <div class="comments-container collapse" id="container_{{= ID }}">
	            ...
	            <form class="child-reply" method="POST">
		            ...
		            <div id="editor_wrap_{{= ID }}" class="child-reaction-wrap collapse">
		            	<div class="wp-editor-container">
		            		<textarea name="post_content" id="insert_reaction_{{= ID }}"></textarea>
		            	</div>
			          	<div class="row submit-wrapper">
