<?php
class ForgivingHeals_SectionBadge {
	/**
     * Field Constructor.
     *
     * @param array $params 
    ...
    ?>
		...
		<div class="desc">
			<!-- <div class="inner"> -->
					...
					<ul class="pay-plans-list">	
						...
						?>					
							<li class="pack-item item" id="pack_<?php echo $pack->ID; ?>" data-ID="<?php echo $pack->ID; ?>">
								<span class="" style="background:<?php echo $pack->forgivingheals_badge_color ?>; width:10px;height:10px;margin-right:10px;"></span>
								<span><?php echo $pack->post_title ?> </span>  
								<?php printf(__("%d points", ET_DOMAIN), $pack->forgivingheals_badge_point); ?>						
								<div class="actions">
				...
				<div class="item">
					<form id="" action="forgivingheals-add-bage" class="forgivingheals-payment-form add-pack-form">
						<div class="form payment-plan">
							...
							<div class="form-item f-left-all clearfix">
								<div class="width33p">
									...
									<input class="bg-grey-input width50p not-empty is-number required number" name="forgivingheals_badge_point" type="text" /> 
								</div>
								<div class="width33p">
									<div class="label"><?php _e("Color", ET_DOMAIN); ?></div>
									<input class="color-picker bg-grey-input width50p not-empty is-number required" type="text" name="forgivingheals_badge_color" /> 							
								</div>
							</div>
							
							<div class="submit">
								<button class="btn-button forgivingheals-submit-btn add_payment_plan">
				...
				<script type="text/template" id="ae-post-item">
					...
					<span class="" style="background:{{= forgivingheals_badge_color }}; width:10px;height:10px;margin-right:10px;"></span>
					<span>{{= post_title }}</span>  
					{{= forgivingheals_point_text }}
					<div class="actions">
				...
				<script type="text/template" id="template_edit_form">
					...
					<form action="forgivingheals-update-badge" class="edit-plan forgivingheals-payment-form">
						<input type="hidden" name="id" value="{{= id }}">
						<input type="hidden" name="forgivingheals_point_text" value="{{= forgivingheals_point_text }}">
						<div class="form payment-plan">
							<div class="form-item">
								<div class="label"><?php _e("Enter a name for your badge", ET_DOMAIN); ?></div>
							...
							<div class="form-item f-left-all clearfix">
								<div class="width33p">
									<div class="label"><?php _e("Point", ET_DOMAIN); ?></div>
									<input value="{{= forgivingheals_badge_point }}" class="bg-grey-input width50p not-empty is-number required number" name="forgivingheals_badge_point" type="text" /> 
								</div>
								<div class="width33p">
									<div class="label"><?php _e("Color", ET_DOMAIN); ?></div>
									<input value="{{= forgivingheals_badge_color }}" class="color-picker bg-grey-input width50p not-empty is-number required" type="text" name="forgivingheals_badge_color" /> 							
								</div>
							</div>
							<div class="submit">
								<button  class="btn-button forgivingheals-submit-btn add_payment_plan">
