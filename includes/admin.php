 ...
 * Adding admin menus
 */
class ForgivingHeals_Admin extends ForgivingHeals
{
    ...
    function get_default_options() {
        ...
        return array(
            ...
            // default accepted reaction mail template
            'accept_reaction_mail_template'    => "<p>Hi [display_name],</p>
                                                <p>Your reaction has been [action] as the best reaction.</p>
                                                <p>You can view your reaction by visit this link:[story_link],</p>
            ...
            //  default alert new reaction mail template
            'new_reaction_mail_template'       => '<p>Hello [display_name],</p>
                                                <p>The story <strong>[story_title]</strong> you are following has a new reaction. </p>
                                                <p>Click the link below to view the story.</p>
                                                <p>[story_link]</p>
                                                <p>Sincerely,<br />[blogname]</p>',
            ...
            //  default pending story mail template
            'pending_story_mail_template' => '<p>Hello Admin,</p>
                                                <p>The new pending story <strong>[story_title]</strong> is waiting for your approval. </p>
                                                <p>Without your acceptance, it won’t be displayed in the site. Please check out the following link to approve the story.</p>
                                                <p>[pending_story_link]</p>
                                                <p>Sincerely,<br />[blogname]</p>',
            //  default pending story mail template
            'best_reaction_mail_template'      =>   '<p>Hi [display_name],</p><p>Your reaction has been [action] as the best reaction.</p><p>You can view your reaction by visit this link:[story_link],</p><p>Sincerely,<br />[blogname]</p>',
    ...
    function admin_setup() {
        ...
        $sections[] = array(
            ...
            'groups' => array(
                array(
                    'args' => array(
                        'title' => __("Filter Bad Words ( Stories / Reactions )", ET_DOMAIN) ,
                        'id'    => 'filter_keywords',
                        'class' => '',
                ...
                array(
                    'args'  => array(
                        ...
                        'id'    => 'intro-text',
                        'class' => '',
                        'desc'  => __("Add custom slugs for story & category here. (You need to save permalink structure to apply this change.)", ET_DOMAIN),
                    ) ,
                    ...
                    'fields' => array(
                        array(
                            'id'          => 'story-slug',
                            'type'        => 'text',
                            'title'       => __("Story Slug", ET_DOMAIN) ,
                            'placeholder' => __("Story Slug", ET_DOMAIN) ,
                            'name'        => 'story_slug',
                            'class'       => 'option-item bg-grey-input ',
                        ),
                        array(
                ...
                array(
                    'args'  => array(
                        'title' => __("Pending Stories", ET_DOMAIN) ,
                        'id'    => 'pending-stories',
                        'class' => '',
                        'desc'  => __("If you enable this option, the new posted stories have to be approved to be displayed.", ET_DOMAIN)
                    ) ,

                    'fields' => array(
                        array(
                            'id'    => 'pending-stories-field',
                            'type'  => 'switch',
                            'title' => __("Pending Stories", ET_DOMAIN) ,
                ...
                array(
                    'args'  => array(
                        'title' => __("Pending Reactions", ET_DOMAIN) ,
                        'id'    => 'pending-reactions',
                        'class' => '',
                        'desc'  => __("If you enable this option, the new posted reactions have to be approved to be displayed.", ET_DOMAIN)
                    ) ,

                    'fields' => array(
                        array(
                            'id'    => 'pending-reactions-field',
                            'type'  => 'switch',
                            'title' => __("Pending Reactions", ET_DOMAIN) ,
                            'name'  => 'pending_reactions',
                            'class' => ''
                        )
                    )
                ),
                ...
                array(
                    'args'  => array(
                        'title' => __("Email Notification For Followed Stories", ET_DOMAIN) ,
                        'id'    => 'following-stories',
                        'class' => '',
                        'desc'  => __("If you enable this option, whenever there’s a new reaction for the followed stories, the system will automatically send emails to the following users.", ET_DOMAIN)
                    ) ,
                    ...
                    'fields' => array(
                        array(
                            ...
                            'name'  => 'forgivingheals_send_following_mail',
                            'class' => ''
                        )
                    )
                ),
                ...
                array(
                    ...
                    'fields' => array(
                        array(
                            ...
                            'type'  => 'switch',
                            'title' => __("Live Notifications", ET_DOMAIN) ,
                            'name'  => 'forgivingheals_live_notifications',
                            'class' => ''
                        )
                    )
                ),
        ...
        $sections[] = array(
            ...
            'groups' => array(
                array(
                    ...
                    'fields' => array(
                        array(
                            ...
                            [title], [link], [excerpt],[desc] : ' . __("story title, link and details", ET_DOMAIN) . ' <br />
                ...
                array(
                    'args' => array(
                        'title' => __("Pending Stories Mail Template", ET_DOMAIN) ,
                        'id'    => 'pending-stories-mail',
                        'class' => '',
                        'name'  => ''
                    ) ,
                    'fields' => array(
                        array(
                            'id'    => 'pending_story_mail_template',
                            'type'  => 'editor',
                            'title' => __("Pending Stories Mail", ET_DOMAIN) ,
                            'name'  => 'pending_story_mail_template',
                            'class' => '',
                            'reset' => 1
                        )
                    )
                ...
                array(
                    'args' => array(
                        'title' => __("New Reaction Mail Template", ET_DOMAIN) ,
                        'id'    => 'new-reaction-mail',
                        'class' => '',
                        'name'  => ''
                    ) ,
                    'fields' => array(
                        array(
                            'id'    => 'new_reaction_mail_template',
                            'type'  => 'editor',
                            'title' => __("New Reaction Mail", ET_DOMAIN) ,
                            'name'  => 'new_reaction_mail_template',
                            'class' => '',
                            'reset' => 1
                        )
                    )
                ...
                array(
                    'args' => array(
                        'title' => __("Best Reaction Mail Template", ET_DOMAIN) ,
                        'id'    => 'best-reaction-mail',
                        'class' => '',
                        'name'  => ''
                    ) ,
                    'fields' => array(
                        array(
                            'id'    => 'best_reaction_mail_template',
                            'type'  => 'editor',
                            'title' => __("Best Reaction Mail", ET_DOMAIN) ,
                            'name'  => 'best_reaction_mail_template',
                            'class' => '',
                            'reset' => 1
                        )
                    )
         ...
         * overview container
         */
        $container = new AE_Overview( array('story' , 'reaction') );
        ...
        */
        $pages[] = array(
            'args' => array(
                ...
                'slug'        => 'et-settings',
                'icon'        => 'gear',
                'desc'        => __("Manage how your ForgivingHeals looks and feels", ET_DOMAIN)
            ) ,
            'container' => $container
        );
        ...
        */
                ...
                array(
                    ...
                    'fields' => array(
                        array(
                            'id' => 'q-vote-up',
                            'type' => 'text',
                            'title' => __("create a story", ET_DOMAIN) ,
                            'name' => 'create_story',
                            'class' => '',
                            'label' => __("create a story", ET_DOMAIN)
                        ) ,
                        array(
                            'id' => 'q-vote-up',
                            'type' => 'text',
                            'title' => __("reaction a story", ET_DOMAIN) ,
                            'name' => 'post_reaction',
                            'class' => '',
                            'label' => __("reaction a story", ET_DOMAIN)
                        ) ,
                        array(
                            'id' => 'q-vote-up',
                            'type' => 'text',
                            'title' => __("story is voted up", ET_DOMAIN) ,
                            'name' => 'q_vote_up',
                            'class' => '',
                            'label' => __("story is voted up", ET_DOMAIN)
                        ) ,
                        array(
                            'id' => 'a-vote-up',
                            'type' => 'text',
                            'title' => __("reaction is voted up", ET_DOMAIN) ,
                            'name' => 'a_vote_up',
                            'class' => '',
                            'label' => __("reaction is voted up", ET_DOMAIN)
                        ) ,
                        array(
                            'id' => 'a-accepted',
                            'type' => 'text',
                            'title' => __("reaction is marked 'accepted' ", ET_DOMAIN) ,
                            'name' => 'a_accepted',
                            'class' => '',
                            'label' => __("reaction is marked 'accepted' ", ET_DOMAIN)
                        )
                         /*,
                        array(
                        'id'        => 'e-accepted',
                ...
                array(
                    ...
                    'fields' => array(
                        array(
                            'id' => 'q_vote_down',
                            'type' => 'text',
                            'title' => __("your story is voted down", ET_DOMAIN) ,
                            'name' => 'q_vote_down',
                            'class' => '',
                            'label' => __("your story is voted down", ET_DOMAIN)
                        ) ,
                        array(
                            'id' => 'a_vote_down',
                            'type' => 'text',
                            'title' => __("your reaction is voted down", ET_DOMAIN) ,
                            'name' => 'a_vote_down',
                            'class' => '',
                            'label' => __("your reaction is voted down", ET_DOMAIN)
                        ) ,

                        array(
                            'id' => 'vote_down',
                            'type' => 'text',
                            'title' => __("you vote down an reaction or story", ET_DOMAIN) ,
                            'name' => 'vote_down',
                            'class' => '',
                            'label' => __("you vote down an reaction or story", ET_DOMAIN)
                        )
                    )
                )
            ) ,
        ...
        // privileges
        $privi = forgivingheals_privileges();
        $fields = array();
        ...
        $temp = array(
            new ForgivingHeals_SectionBadge(array(
