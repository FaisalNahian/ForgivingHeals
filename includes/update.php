...
class ET_Update
{
	...
	/**
	 * Initialize a new instance of the ForgivingHeals Theme Auto-Update class
	 *
...
/**
 * Handle updating themes for MaxWeb
 */
...
function et_check_update(){
	...
	$update_path = ET_UPDATE_PATH . '&product=ForgivingHeals&type=theme';
	new ET_Theme_Updater(ET_VERSION, $update_path, 'ForgivingHeals', 'http://maxweb.us');
	// add menu update
	new ET_Menu_Update();
