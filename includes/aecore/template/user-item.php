		...
		<div class="et-act">
			<?php if ( !$user->is_ban ) { ?>
				<span class="user-points">
					<input type="text" value="<?php echo $user->forgivingheals_point ? $user->forgivingheals_point : 0;  ?>" class="regular-input" name="forgivingheals_point" /> <?php _e('Points', ET_DOMAIN) ?>
				</span>
