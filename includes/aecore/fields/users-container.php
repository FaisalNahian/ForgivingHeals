<?php
/**
 * Class render user manage in MaxWeb backend
 * - list user
 * - search user
 * - load more user
 * @since 1.0
				...
				<div class="et-mem-container">
					...
					<div class="et-act">
						<# if ( !banned ) { #>
							<span class="user-points">
								<input type="text" value="{{= forgivingheals_point }}" class="regular-input" name="forgivingheals_point" /> <?php _e('Points', ET_DOMAIN) ?>
							</span>
					...
					<div class="et-mem-detail">
						<div class="et-mem-top">
							...
							<span class="thread icon" data-icon="w">{{= et_story_count }}</span>
							<span class="comment icon" data-icon="q">{{= et_reaction_count }}</span>
						</div>
