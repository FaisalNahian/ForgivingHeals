<?php 
    ...
    if( !empty($query) ) {
        ...
        ?>
            <div class="tag-item">
                <a href="<?php echo get_term_link( $tag, 'forgivingheals_tag' ); ?>" class="q-tag"><?php echo $tag->name ?></a> x <?php echo $tag->count ?>
                <p><?php echo forgivingheals_count_post_in_tags( $tag->slug ) ?></p>
            </div>
        <?php 
        }
    }
