...
?>
<div class="modal fade modal-submit-stories" id="login_register" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	    ...
	    <div class="modal-content">
	      ...
	      <div class="modal-body">
	        ...
	        <form id="signup_form" class="form_modal_style">
	        	...
	        	<?php do_action( 'forgivingheals_after_signup_form' ); ?>
