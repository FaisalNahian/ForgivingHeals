                	...
                	<div class="point-system">
                        ...
                        <ul class="list-point">
                            ...
                            <li>
                            	...
                            	<p class="point-text"><i class="fa fa-star"></i><?php _e("reaction is voted up", ET_DOMAIN) ?></p>
                            </li>
                            <li>
                            	<span class="point-circle">+ <?php echo $badge_points->a_accepted ? $badge_points->a_accepted : 0  ?></span>
                            	<p class="point-text"><i class="fa fa-star"></i><?php _e("reaction is accepted", ET_DOMAIN) ?></p>
                            </li>
                            <!-- <li>
						...
						<div class="badges-point-system">
                            <div class="list-bag-profile-wrapper user-list">
                                ...
                                <span class="point-profile">
                                    <span><?php echo $pack->forgivingheals_badge_point ?><i class="fa fa-star"></i></span><?php _e("points require", ET_DOMAIN) ?>
                                </span>
                            </div>
                            <h2 class="title-system"><?php _e("With you can do:", ET_DOMAIN) ?></h2>

                            <span class="role-user-system">
                                <i class="fa fa-<?php echo $pack->forgivingheals_badge_point >= $levels->edit_story ? 'check' : 'ban' ?>"></i><?php _e("Edit other people's stories", ET_DOMAIN) ?>
                            </span>

                            <span class="role-user-system">
                                <i class="fa fa-<?php echo $pack->forgivingheals_badge_point >= $levels->edit_reaction ? 'check' : 'ban' ?>"></i><?php _e("Edit other people's reactions", ET_DOMAIN) ?>
                            </span> 

                            <span class="role-user-system">
                                <i class="fa fa-<?php echo $pack->forgivingheals_badge_point >= $levels->vote_down ? 'check' : 'ban' ?>"></i><?php _e("Vote down (costs 1 point on reactions)", ET_DOMAIN) ?>
                            </span>

                            <span class="role-user-system">
                                <i class="fa fa-<?php echo $pack->forgivingheals_badge_point >= $levels->add_comment ? 'check' : 'ban' ?>"></i><?php _e("Leave comments", ET_DOMAIN) ?>
                            </span>

                            <span class="role-user-system">
                                <i class="fa fa-<?php echo $pack->forgivingheals_badge_point >= $levels->vote_up ? 'check' : 'ban' ?>"></i><?php _e("Vote up", ET_DOMAIN) ?>
                            </span>
