...
<li <?php post_class( 'story-item' );?> data-id="<?php echo $post->ID ?>">
    ...
    <div class="content-story">
        <h2 class="title-story">
            <a href="<?php echo get_permalink($story->ID); ?>"><?php the_title() ?></a>
        </h2>
        <div class="info-tag-time">
            ...
            <span class="time-categories"><?php printf( __( 'Submitted %s in', ET_DOMAIN ),$et_post_date); ?> <a href="<?php echo $category_link ?>"><?php echo $category ?></a>.</span>
        </div>
        ...
        <div class="vote-wrapper text-right">
        	<span class="reaction-active-label float-none"><i class="fa fa-check"></i><?php _e("Accepted", ET_DOMAIN) ?></span>
        </div>
        <?php } ?>
    </div>
</li>