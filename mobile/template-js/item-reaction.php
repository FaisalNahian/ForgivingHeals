<script type="text/template" id="mobile_reaction_item">
            	...
            	<div class="content-qna-wrapper">
                    ...
                    <div class="content-story">
                        ...
                        <div class="vote-wrapper">
                            ...
                            <a href="javascript:void(0)" data-name="accept-reaction" class="action reaction-active-label pending-reactions"><?php _e("Accept", ET_DOMAIN) ?></a>
                            <# } #>
                        </div>
                    </div>
                </div>
