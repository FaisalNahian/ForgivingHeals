		...
		<div class="container-fluid">
			<div class="row">
					...
					<div class="col-md-8 col-xs-8">
                        ...
                        <div class="header-search-wrapper">
                        	<section class="buttonset">
                                <button id="showLeftPush"><i class="fa fa-story"></i></button>
				...
				<div class="col-md-12 col-xs-12" id="header_sidebar">
					<?php if(is_active_sidebar( 'forgivingheals-header-sidebar' )) dynamic_sidebar( 'forgivingheals-header-sidebar' ); ?>
				</div>