    ...
    <div class="col-md-8 main-content">
        ...
        <div class="main-user-list">
            <ul id="main_users_list" class="row">
                <?php
                    $number     = apply_filters( 'forgivingheals_users_list_display', 10 );
                    ...
                    if(isset($_GET['sort']) && $_GET['sort'] == "points"){
                        $args['meta_key'] = 'forgivingheals_point';
                    ...
                    $query       = new ForgivingHeals_User_Query($args);
                    // echo "<pre>";
                    // print_r($query) ;
                    // echo "</pre>";
                ...
                <li class="user-item col-md-4 col-xs-6">
                    ...
                    <div class="left-info">
                        ...
                        <div class="story-cat">
                            ...
                            <span class="points"><?php printf(__("%d Points", ET_DOMAIN), (int)forgivingheals_get_user_point($user->ID) ) ?> </span>
                        </div>
                    </div>
                </li>
                <?php
