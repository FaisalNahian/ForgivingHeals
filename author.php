    ...
    <div class="col-md-8 main-content">
        ...
        <div class="row user-statistic highlight">
            ...
            <div class="col-md-7 col-xs-12 user-post-count">
                <div class="row">
                    <div class="col-md-4 col-xs-4 story-cat">
                    ...
                    <div class="col-md-4 col-xs-4">
                        <p class="stories-count">
                            ...
                            <span><?php echo et_count_user_posts($user->ID, 'story'); ?></span>
                        </p>
                    </div>
                    <div class="col-md-4 col-xs-4">
                        <p class="reactions-count">
                            <?php _e('Reactions',ET_DOMAIN) ?><br>
                            <span><?php echo et_count_user_posts($user->ID, 'reaction'); ?></span>
                        </p>
                    </div>
        ...
        <div class="row story-filter">
            <div class="col-md-12 sort-stories">
                <ul>
                    <li>
                        <a class="<?php if(!isset($_GET['type'])) echo 'active'; ?>" href="<?php echo get_author_posts_url($user->ID); ?>"><?php _e('Stories',ET_DOMAIN) ?></a>
                    </li>
                    <li>
                        <a class="<?php if(isset($_GET['type']) && $_GET['type'] == "reaction") echo 'active'; ?>" href="<?php echo add_query_arg(array('type'=>'reaction')); ?>"><?php _e('Reactions',ET_DOMAIN) ?></a>
                    </li>
                    <?php if($current_user->ID == $user->ID){ ?>
                    <li>
