...
<html <?php language_attributes(); ?>>
                	...
                	<div class="col-md-7">
                    	<div class="intro-text">
                        	<h2 class="slide-text">
                                ...
                                ?>
                            	<!-- Not just another
                            	<span class="adject">MaxWeb|Geek|Cool|Lazy|Nerd</span>
								WordPress theme, -->
                            </h2>
                            <h3 class="text-bottom">
                                ...
                                ?>
                                <!-- ForgivingHeals aims to take the knowledge sharing <br>
    ...
    <?php
        forgivingheals_reset_password_modal()
    ?>
    <!-- MODAL RESET PASSWORD -->
    <?php
        forgivingheals_login_register_modal();
